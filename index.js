...
function generateFakeDeviceData(deviceId) {
    ...
    // ส่งคืนข้อมูลในรูปแบบเดียวกับข้อมูลจริงจาก Shadow
    return {
      alias: deviceId,
